...
public class CheckoutResource {
	...
	@Autowired
	private ShoppingCartService shoppingCartServcie;
	...
	public Order checkoutPost(@RequestBody HashMap<String, Object> mapper,Principal principal) {
		...
		shoppingCartServcie.clearShoppingCart(shoppingCart);
		
		LocalDate today = LocalDate.now();
		LocalDate estimateDeliveryDate;
		if(shippingMethod.equals("groundShipping")) {
			estimateDeliveryDate = today.plusDays(5);
		}else {
			estimateDeliveryDate = today.plusDays(3);
		}
